...
which condition establishes that the traversing element/variable has
 reached the first element? */

// Ans 1
// create a basic circular linked list to start solution
#include <iostream>
using namespace std;
// Creating Node class
class Node{
...
//Function to put a node at the end
...
1)Multiplayer Games: All the Players are kept in a Circular Linked List and the pointer keeps on moving 
...
3)Fibonacci Heap: Circular Linked List is also used in the implementation of advanced data structures 
...
5)Implementation of Data Structure: Data structures such as stacks and queues are implemented with the
 help of the circular linked lists.
6)Audio/Video Streaming: Circular linked list is also used in audio and video streaming,for ex. when 
one copmlete audio list finishes playing in music player then it again starts playing from start.
*/
